    ...
    <div class="content-page">
      <div class="content">
       <div class="container">
        ...
        <div class="row pt-5">
          <div class="col-sm-12">
            <h4 class="pull-left page-title text-black">POS (Point of Sale) </h4>
            <ol class="breadcrumb pull-right">
              <li class="text-black">{{ date('d/m/y') }}</li>
            </ol>
          </div>
        </div><br>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="pricing-footer">
             ...
             <form method="post" action="{{ url('/invoice') }}">
              ...
              @endif
              <h4 class="text-info">
                <a href="#" class="btn btn-sm btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#con-close-modal">Add New Customer</a>
              </h4>
              @php 
